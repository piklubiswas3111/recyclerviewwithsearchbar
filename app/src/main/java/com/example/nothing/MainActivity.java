...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem item = menu.findItem(R.id.search_men);

        androidx.appcompat.widget.SearchView earchView = (androidx.appcompat.widget.SearchView) item.getActionView();
        earchView.setOnQueryTextListener(new androidx.appcompat.widget.SearchView.OnQueryTextListener() {
            @Override
            ...
            public boolean onQueryTextChange(String newText) {
                adtpter.getFilter().filter(newText);
                return false;
            }
        });
